...
from models import vggverb_role_joint_eval, vgg_verb_classifier, ggnn_baseline
...
def main():
    ...
    model = getattr(vggverb_role_joint_eval, constructor)(vgg_verb_model, tda_role_module)
    ...
    print('successfully loaded ggnn model!')

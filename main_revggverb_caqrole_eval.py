...
from models import revgg_caq_joint_eval, vgg_verb_classifier, top_down_verb, top_down_baseline, top_down_query_context, top_down_baseline_addemb
...
def main():
    ...
    tda_verb_model = getattr(top_down_verb, constructor)(encoder.get_num_labels(),  encoder.get_num_verbs(), role_module)

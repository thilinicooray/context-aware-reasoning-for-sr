...
def main():
    ...
    parser.add_argument('--model', type=str, default='top_down_image_context')
    ...
    model = getattr(top_down_image_contex, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)

...
def main():
    ...
    parser.add_argument('--model', type=str, default='top_down_verb')
    ...
    model = getattr(top_down_verb, constructor)(encoder.get_num_labels(),  encoder.get_num_verbs(), role_module)

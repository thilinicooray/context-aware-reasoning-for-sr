'''
Implementation of CAI model.
pretrained TDA is used to ontain required information to generate context.
'''
...
class Top_Down_Image_Context(nn.Module):
    def __init__(self, baseline_model, covnet, role_emb, verb_emb, query_composer, v_att, q_net,
        ...
        super(Top_Down_Image_Context, self).__init__()
...
def build_top_down_image_context(n_roles, n_verbs, num_ans_classes, encoder, baseline_model):
    ...
    return Top_Down_Image_Context(baseline_model, covnet, role_emb, verb_emb, query_composer, v_att, q_net,
                                  v_net, neighbour_attention, resize_ctx, Dropout_C, classifier, encoder)

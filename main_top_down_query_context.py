...
from models import top_down_query_context, top_down_baseline
...
def main():
    ...
    parser.add_argument('--model', type=str, default='top_down_query_context')
    ...
    model = getattr(top_down_query_context, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)
